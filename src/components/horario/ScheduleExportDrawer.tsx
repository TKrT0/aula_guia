...
import { exportAsImage } from '@/src/lib/utils/exportSchedule' // ajusta ruta si tu archivo se llama distinto
import { generateSchedulePDF } from '@/src/components/horario/SchedulePDF' // ajusta si está en otra ruta
